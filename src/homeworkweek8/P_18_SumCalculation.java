 ...
 */
public class P_18_SumCalculation {
    public static void main(String[] args) {
        P_18_SumCalculation calculation = new P_18_SumCalculation();
        calculation.setFirstNumber(5.0);
        calculation.setSecondNumber(4);
        System.out.println("add =" + calculation.getAdditionResult());
        System.out.println("subtract =" + calculation.getSubtractionResult());
        calculation.setFirstNumber(5.25);
        calculation.setSecondNumber(0);
        System.out.println("multiply =" + calculation.getMultilicatioResult());
        System.out.println("divide =" + calculation.getDivision());
    ...
    public double getMultilicatioResult() {
        return firstNumber * secondNumber;
    }
